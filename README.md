...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=linux,kali,ubuntu,ts,bash,selenium,raspberrypi,js,nodejs,nginx,python,c,cpp,react,next,tailwind,bootstrap,html,css,flask,django,express,mongodb,postgres,redis,firebase,aws,gcp,docker,git,postman,tensorflow,pytorch,opencv&perline=9" />
  </a>
</p>
